...
class ROUPLOADERUI:
    def __init__(self, root):
        ...
        self.create_api_button = ttk.Button(
            self.create_api_tab, text="Create API Key", command=self.create_api_key
        )

        self.note_label = ttk.Label(
            self.create_api_tab,
            text="Note: If you already created 1 API key on the account you dont have to recreate it, You recreate when you get banned!",
            style="TLabel",
            font=("Helvetica", 10),
        )
        ...
        self.browse_button = ttk.Button(
            self.main_tab, text="Browse", command=self.browse_file
        )
        ...
        self.asset_type_label = ttk.Label(self.main_tab, text="Asset Type:")
        ...
        self.upload_button = ttk.Button(
            self.main_tab, text="Upload Asset", command=self.upload_asset
        )
        ...
        self.letter_size_label = ttk.Label(
            self.settings_tab, text="Size of the letters:"
        )
        ...
        self.letter_amount_label = ttk.Label(
            self.settings_tab, text="Amount of letters:"
        )
        ...
        self.github_link.bind(
            "<Button-1>", lambda e: self.open_link("https://github.com/5nz")
        )
        ...
        self.discord_link.bind(
            "<Button-1>", lambda e: self.open_link("https://discord.gg/4wffQmV6mR")
        )

        self.note_label = ttk.Label(
            self.credits_tab,
            text="Note: This tool use's the shitty ROBLOX open cloud API, MEANING this will get flagged down quick and may lead to instant declines!",
            style="TLabel",
            font=("Helvetica", 10),
        )
        self.note_label.pack(side=tk.BOTTOM, fill=tk.X)
        ...
        self.note_label2 = ttk.Label(
            self.credits_tab,
            text="Note: This tool is for educational purposes only. Use at your own risk.",
            style="TLabel",
            font=("Helvetica", 10),
        )
    ...
    success_Notification = Notify(
          ...
          default_application_name="ROUPLOADER",
    ...
    def upload_asset(self):
        ...
        if asset_file:
            try:
                ...
                messagebox.showinfo(
                    "Uploading",
                    "Starting uploading, please be patient. Check the Logs tab if needed.",
                )
    ...
    def save_settings(self):
        ...
        messagebox.showinfo("Settings Saved", "Saved settings successfully!")
